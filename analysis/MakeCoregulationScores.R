...
if(i %in% small_tissues){load(paste0("predicted_expression_1KG/allEUR/designmat_",tissues[i],"_v8_allEUR_double.RData"))}else{
load(paste0("predicted_expression_1KG/320EUR/designmat_",tissues[i],"_v8_320EUR_double.RData"))}
print(dim(df1))
df1_focal <- df1
rm("df1")
